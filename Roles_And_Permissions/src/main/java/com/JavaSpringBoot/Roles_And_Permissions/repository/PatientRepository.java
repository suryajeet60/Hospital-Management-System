...
import com.JavaSpringBoot.Roles_And_Permissions.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.JavaSpringBoot.Roles_And_Permissions.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
